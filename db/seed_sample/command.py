...
SAMPLE_ORGANIZATIONS: tuple[SeedOrganization, ...] = (
    SeedOrganization(301, "Zenith Corp", "enterprise", "https://zenith.example.com", "BKC, Bandra East", "400051", "Mumbai", "Maharashtra", "India", 1101, "HR Director", 202, "active", 201, 201),
    SeedOrganization(302, "Apex Retail", "retail", "https://apex.example.com", "Hitech City", "500081", "Hyderabad", "Telangana", "India", 1102, "People Ops Lead", 202, "active", 201, 202),
    SeedOrganization(303, "Nimbus Logistics", "logistics", "https://nimbus.example.com", "Electronic City", "560100", "Bengaluru", "Karnataka", "India", 1103, "Admin Head", 205, "inactive", 205, 205),
    SeedOrganization(304, "Legacy Foods", "manufacturing", "https://legacy.example.com", "Sector V", "700091", "Kolkata", "West Bengal", "India", 1104, "HR Manager", 205, "archived", 205, 205),
)
...
async def _upsert_organizations(session: AsyncSession, organizations: Iterable[SeedOrganization]) -> None:
    for seed in organizations:
        ...
        row.state = seed.state
        row.country = seed.country
        row.contact_person = seed.contact_person
