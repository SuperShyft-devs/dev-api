"""Load BioAI reports from MetSights for all engagements.

Same as ``db.jobs.load_bioai_reports`` but includes every engagement status,
not only running.

Entrypoint: ``python -m db.jobs.all_engagements.load_bioai_reports --yes``
"""
...
def _build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Load BioAI reports from MetSights for all engagements."
    )
