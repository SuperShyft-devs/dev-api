"""Load FitPrint fitness reports from MetSights for all engagements.

Entrypoint: ``python -m db.jobs.all_engagements.load_fitprint_reports --yes``
"""
...
def _build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Load FitPrint fitness reports from MetSights for all engagements."
    )
...
def main(argv: list[str] | None = None) -> int:
    ...
    print(
        f"\nLoad FitPrint reports for all engagements ({mode}):\n"
